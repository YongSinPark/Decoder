set_property SRC_FILE_INFO {cfile:D:/xilinx_2020/Bcd_to_fnd/Bcd_to_fnd.srcs/constrs_1/imports/gates/MY_Basys-3-Master.xdc rfile:../../../Bcd_to_fnd.srcs/constrs_1/imports/gates/MY_Basys-3-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { i_disit_select[0] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property src_info {type:XDC file:1 line:28 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { i_disit_select[1] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
...
set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { o_disit[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=DP
set_property src_info {type:XDC file:1 line:64 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { o_disit[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=DP
set_property src_info {type:XDC file:1 line:65 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { o_disit[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=DP
set_property src_info {type:XDC file:1 line:66 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { o_disit[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=DP
